...
class GateEvidenceBundleV2Tests(unittest.TestCase):
    ...
    def test_r60_one_shot_repair_supplement_is_required(self) -> None:
        stage = "R60_ONE_SHOT_CLI_PRODUCTION_ADMISSION"
        self.assertIn(stage, gebv.REQUIRED_STAGES)
    ...
    def test_r61_qwen_adapter_supplement_is_required(self) -> None:
        stage = "R61_QWEN_ONE_SHOT_PRODUCTION_ADAPTER"
        self.assertIn(stage, gebv.REQUIRED_STAGES)
    ...
    def test_r62_kimi_adapter_supplement_is_required(self) -> None:
        stage = "R62_KIMI_ONE_SHOT_PRODUCTION_ADAPTER"
        self.assertIn(stage, gebv.REQUIRED_STAGES)
