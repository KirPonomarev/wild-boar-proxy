...
class ModelIntelligenceAndSpeedMetadataFidelityR1ProbeTests(unittest.TestCase):
    def test_build_packets_keep_metadata_truth_narrow(self) -> None:
        ...
        self.assertTrue(api["all_api_tiers_unavailable_unknown"])
        self.assertEqual(api["api_metadata_truth_strength"], "unknown_unproven_only")
        ...
        self.assertTrue(source_proof["all_current_rows_unavailable_unknown"])
        self.assertTrue(source_proof["display_rows_unavailable_unknown"])
        self.assertTrue(source_proof["selector_rows_unavailable_unknown"])
        self.assertTrue(source_proof["metadata_completeness_without_stronger_truth"])
        ...
        self.assertTrue(speed["unknown_speed_tiers_present"])
