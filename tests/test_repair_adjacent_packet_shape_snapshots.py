...
class RepairAdjacentPacketShapeSnapshotTests(unittest.TestCase):
    ...
    def test_status_absent_listener_packet_shape_delegates_healthcheck_truth(self) -> None:
        ...
        _assert_subset(
            self,
            {
                "human_message": "Runtime status summary reflects live attestation failure.",
                "effective_mode": "stable",
                "endpoint": "<ENDPOINT>",
                "attestation_summary": {
                    "status": "error",
