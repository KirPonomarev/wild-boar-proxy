...
class ControlledApiDispatchTests(unittest.TestCase):
    def test_controlled_dispatch_proves_route_bound_bridge_backed_api_lane(self) -> None:
        ...
        self.assertEqual(packet["selected_mode"], "api_only")
        self.assertEqual(packet["orchestrator"], "api_route")
        self.assertEqual(packet["executor"], "api_route")
        self.assertTrue(packet["runtime_dispatch_mode_truth_recorded"])
        self.assertTrue(packet["dispatch_mode_truth_proven"])
        self.assertTrue(packet["api_only_mode_proven"])
        self.assertTrue(packet["api_mode_proven"])
        self.assertFalse(packet["chatgpt_only_mode_proven"])
        self.assertFalse(packet["gpt_api_mode_proven"])
        self.assertFalse(packet["chatgpt_lane_selected"])
