...
class WebDesignUiTests(unittest.TestCase):
    ...
    def test_codex_custom_sessions_ui_is_lifecycle_not_inference(self) -> None:
        ...
        self.assertNotIn("runCodexCustomSessionPrompt()", js)
        self.assertNotIn("postCodexCustomSessionAction(\"prompt\", { prompt: promptNode ? promptNode.value : \"\" })", js)
        self.assertNotIn('id="codexCustomSessionPromptRunAction"', html)
