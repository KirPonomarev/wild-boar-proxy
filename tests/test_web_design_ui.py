...
"""
    ...
    def test_source_switch_ignores_stale_snapshot_responses(self) -> None:
        ...
        # Source-transition abort signal is wired into fetch calls via the
        # local `signal` variable (derived from sourceTransitionAbortController).
        self.assertGreaterEqual(js.count("signal }"), 6)
