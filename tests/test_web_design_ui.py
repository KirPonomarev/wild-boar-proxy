...
"""
    ...
    def test_settings_screen_is_readonly_with_safe_actions_and_deferred_controls(self) -> None:
        ...
        self.assertIn('data-visual-reference="14_settings_main_hub"', html)
        self.assertIn('data-config-mode="readonly"', html)
        self.assertIn("Runtime / Mode", html)
        self.assertIn("Client / Launch", html)
        self.assertIn("Accounts policy", html)
        ...
        self.assertIn("сырой route config не отправляется из браузера", html)
        self.assertIn("секреты и токены не вводятся в UI", html)
