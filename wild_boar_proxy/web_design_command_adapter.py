...
ALLOWLIST: dict[str, CommandSpec] = {
    ...
    "accounts_release": CommandSpec(
        command_id="accounts_release",
        argv_template=("accounts", "release", "{account_id}", "--json"),
        category="lifecycle",
        confirmation_required=True,
        required_args=("account_id",),
        allowed_args=("account_id",),
    ...
    "external_models_routes_validate": CommandSpec(
        command_id="external_models_routes_validate",
        argv_template=("external-models", "routes", "validate", "--route", "{route_id}", "--json"),
    ...
    "external_models_credentials_status_provider": CommandSpec(
        command_id="external_models_credentials_status_provider",
        argv_template=("external-models", "credentials", "status", "--provider", "{provider}", "--json"),
        category="external_models_credential_admission",
        ui_enabled=False,
        required_args=("provider",),
        allowed_args=("provider",),
    ),
    ...
    "external_models_credentials_admit_provider_owner_env": CommandSpec(
        command_id="external_models_credentials_admit_provider_owner_env",
        argv_template=(
            "external-models",
            "credentials",
            "admit",
    ...
    "external_models_routes_remove": CommandSpec(
        command_id="external_models_routes_remove",
        argv_template=("external-models", "routes", "remove", "--route", "{route_id}", "--json"),
        category="external_models_registry_cleanup",
        confirmation_required=True,
        required_args=("route_id",),
        allowed_args=("route_id",),
    ),
    ...
    "external_models_live_format_check": CommandSpec(
